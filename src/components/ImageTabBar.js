        ...
        >
          <View style={[styles.tab, this.props.tabStyle, ]}>
            ...
            <View >
                ...
                { (this.props.badgeNum > 0 || false) && page===1 &&
                <View style={[Common.badgePos, Common.badgeCircle, Common.badgeColorAtTab]}>
                  <Text style={[Common.badgeText, Common.badgeTextAtTab]}>{this.props.badgeNum}</Text>
                </View>
                }
            </View>
